...
hsa_mirna_clean <- read_rds(path = file.path(human_path_mirna, "rds_02_hsa_snorna_clean.rds.gz"))
...
write_rds(hsa_mirna_clean_seq_ready, path = file.path(human_path_mirna, "rds_03_hsa_snorna_clean_seq_ready.rds.gz"), compress = "gz")
