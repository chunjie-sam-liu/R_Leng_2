...
ggplot(brca.stat, aes(x = tumor.file_size / normal.file_size, y = log10(numb))) + geom_point() + theme_minimal() + scale_x_continuous(name = "Tumor / Normal File size") + scale_y_continuous(name= "Log10(# of Mutations)") 
...
ggplot(brca.stat, aes(x="normal", y = normal.extracted_size /normal.file_size)) + geom_boxplot() +geom_jitter(position=position_jitter(width=.2, height=0))+ theme_minimal() + scale_x_discrete(name="Normal") + scale_y_continuous(name = "File size of regulatory region / WXS")
```
